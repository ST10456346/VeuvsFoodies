  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sideButtons}>
        <TouchableOpacity onPress={() => navigation.navigate('ViewFullMenu')} style={styles.sideButton}>
          <Text style={styles.sideButtonText}>View Full Menu</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => navigation.navigate('Chefsloginpage')} style={styles.sideButton}>
          <Text style={styles.sideButtonText}>Chefs Login</Text>
        </TouchableOpacity>
      </View>
